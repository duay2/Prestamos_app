...
class PrestamosWindow(ttk.Frame):
    ...
    def crear_widgets(self):
        ...
        title_label = ttk.Label(main_frame, text="Gestión de Préstamos", font=('Segoe UI', 18, 'bold'))
        ...
        title_label = tk.Label(filter_frame, text="Búsqueda y Filtros", bg='white', fg='#2C3E50', font=('Segoe UI', 10, 'bold'))
        ...
        ttk.Radiobutton(filter_row1, text="Monto", variable=self.tipo_busqueda, value="monto", style='Filter.TRadiobutton').pack(side='left', padx=(0, 10))
        ttk.Radiobutton(filter_row1, text="ID Préstamo", variable=self.tipo_busqueda, value="id", style='Filter.TRadiobutton').pack(side='left')
        ...
        tk.Label(filter_row2, text="Estado:", bg='white', fg='#2C3E50', font=('Segoe UI', 9)).pack(side='left', padx=(0, 5))
    ...
    def nuevo_prestamo(self):
        ...
        # Recargar clientes para incluir los nuevos
        self.cargar_clientes()
